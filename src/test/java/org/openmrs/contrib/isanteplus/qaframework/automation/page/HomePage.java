...
public class HomePage extends Page {
	...
	private static final By SYSTEM_ADMINISTRATION = By.cssSelector(
			"coreapps-systemadministration-homepageLink-coreapps-systemadministration-homepageLink-extension");
